  ...
  return (
    <div className="">
      <img
        src="/bg/bg3.jpg"
        loading="lazy"
        className="absolute h-[100vh] -z-10 top-0 left-0 w-[100vw] object-cover object-top"
        alt=""
      />
      ...
      <div className="flex flex-wrap justify-evenly md:px-28 bg-[#AEA085] bg-opacity-60">
        <div className="relative">
          <img src="bg/bg2.jpg" className="w-[15vw] m-5" alt="" />
        ...
        <div className="tracking-normal w-[40%] mt-14 text-lg text-center md:leading-6 text-[#58381C] font-semibold">
          <p>
          ...
          {/* <Link
            to={"/mars"}
            className="border-2 border-white p-1 px-4 my-4 text-lg font-semibold flex items-center rounded transition-all delay-250 ease-in hover:bg-[#7e6249] w-fit mx-auto hover:text-white hover:border-slate-300"
          >
